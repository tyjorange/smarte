...
public class MessageBodyDataValue {
	 ...
	 * 指标类型ID。
	 */
	//public static final String[] typeIds = {"ygdl", "dqyygdl", "wgdl", "dqywgdl", "dy", "dl", "yggl", "wggl", "glys", "wd", "pl"};
	public static final Short[] typeIds = {10, 3, 8, 2, 4, 1, 11, 9, 5, 7, 6};
	/**
	 * 指标数值。
	 */
